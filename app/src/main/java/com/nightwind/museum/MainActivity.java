...
public class MainActivity extends ActionBarActivity
    ...
    private static final int REQUEST_SCANNER = 0;
    /**
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_SCANNER && resultCode == RESULT_OK) {
            String resultQrCode = data.getStringExtra(ScannerActivity.RESULT_DATA_QR_CODE);
            Toast.makeText(this, "result qr code: " + resultQrCode, Toast.LENGTH_SHORT).show();
        }
    }
}
